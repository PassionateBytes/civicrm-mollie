    ...
    <tr>
      ...
      <td class="mollie-detail-item-links">
        {if $item.dashboard_url}
          <a href="{$item.dashboard_url}" onclick="window.open(this.href); return false;"><i class="crm-i fa-external-link"></i> {ts domain="nl.stichtinggast.mollie"}Open in Mollie{/ts}</a>
        {/if}
